...
class LanguagePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(t.languageSettings.language, style: const TextStyle(fontWeight: FontWeight.bold))),
      body: Center(
        child: Container(
              ...
              ...[null, ...AppLocale.values].map((locale) {
                return ListTile(
                  ...
                  title: Row(
                    children: [
                      Flexible(
                        child: Text(locale?.humanName ?? t.languageSettings.system),
                      ),
