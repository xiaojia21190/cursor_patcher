    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // DebugEntry(name: 'App Arguments', value: appArguments.isEmpty ? null : appArguments.join(' ')),
          DebugEntry(name: 'Dart SDK Version', value: Platform.version),
          DebugEntry(name: 'Platform', value: Platform.operatingSystem),
          DebugEntry(name: 'Platform Version', value: Platform.operatingSystemVersion),
        ],
      ),
    );
  }
...
class CopyableText extends StatelessWidget {
  ...
  const CopyableText({super.key, this.prefix, required this.name, required this.value});
